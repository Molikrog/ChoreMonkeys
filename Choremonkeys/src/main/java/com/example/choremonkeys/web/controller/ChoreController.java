...
//    // show all chores
//    @GetMapping({"/", "/chores"})
//    public String showChores(Model model, @RequestParam (required = false)ChoreStatus choreStatus) {
//        List<Chore> chores = this.choreService.findAll();
//        model.addAttribute("chores", chores);
//        model.addAttribute("choreStatus", choreStatus);
//
//        return "body";
//    }
//
...
//                         @RequestParam ChoreStatus choreStatus) {
//        // For now, hardcode user ID = 1
//        choreService.createChore(title, description, destination, phoneNumber, price, 1L, choreStatus);
...
//        choreService.update(id, title, description, destination, phoneNumber, price, 1L, choreStatus);
//        return "redirect:/chores";
//    }
//
//
